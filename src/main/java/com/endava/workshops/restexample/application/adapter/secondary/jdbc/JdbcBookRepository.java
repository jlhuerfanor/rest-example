package com.endava.workshops.restexample.application.adapter.secondary.jdbc;
...
@Repository
public interface JdbcBookRepository extends BookRepository, CrudRepository<Book, Integer> {
